...
namespace Chroma 
{
  ...
  void calculate_FieldStrength(const multi1d<LatticeColorMatrix>& u, int mu1, int nu1, LatticeColorMatrix &Fmunu_lat)
  {
    ...
    LatticeColorMatrix c1x1 = C_mxn(U, 1, 1, mu, nu);
    LatticeColorMatrix c2x2 = C_mxn(U, 2, 2, mu, nu);
    LatticeColorMatrix c1x2 = C_mxn(U, 1, 2, mu, nu);
    LatticeColorMatrix c1x3 = C_mxn(U, 1, 3, mu, nu);
  ...
  void weinberg_ggg_new(const multi1d<LatticeColorMatrix>& u, 
